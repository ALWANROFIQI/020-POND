...
?> 	 
		...
		<div class="col-md-9">
			...
			<div class="col-md-12">
				...
				<thead>
				<tr style="background:#5FD304;font-weight:bold;">
...
<?php } } ?>
       ...
       <table class="table table-bordered">
           ...
           <tr>
               ...
               <td><b><?php echo "Rp ".number_format($total, 3, '.', '.') ?></a></td>
           </tr>
       </table>
       <form action="<?php echo  $url.'order.php' ?>" method="POST"> 
           <input type="hidden" name="okay" value="cart">
           <button style="background:#5FD304;<?php echo ($total == 0)? 'disabled' : '' ?> type="submit" class="btn btn-primary">Selesai Belanja &raquo;</button>
       </form>
    </div>
